        ...
        <Typical 
         ...
         <div className="sobreBlocos">
            <div>
                ...
                <p className="texto paragrafoSobre textoNegrito"><FaMouse color="#00d2df"/> Sou desenvolvedor front-end, estudando tecnologias back-end visando ser um desenvolvedor full-stack e tenho muito conhecimento em análise de dados, data science e machine learning.</p>
            </div>
